...
#define RHEOSTAT_PIN 22                        // default disabled, change to pin# for rheostat analog input
#define RHEOSTAT_CHANGE_THRESHOLD 5            // default >= 5% change before setting a new rate
#define RHEOSTAT_RATE_MINIMUM 0.50             // default slowest guide rate is 1.0x the sidereal rate
#define RHEOSTAT_RATE_MAXIMUM 0.75             // default fastest guide rate is 0.5x the goto rate
